...
export const promotionTypeEnum = ["PERCENT", "FIXED"] as const;
export const paymentMethodEnum = ["CASHIER"] as const;
export const paymentStatusEnum = ["NONE", "SUBMITTED", "VERIFIED", "REJECTED"] as const;
